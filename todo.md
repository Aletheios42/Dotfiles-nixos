!! revisar tipos y sus assertions
    - los path
    - los puertos
!! estudiar libOPtionalSring para zsh
!! limpiar persist con tempfile (preguntar egor)
!! tener mi propia libreria para funciones que use recurrentemente
    - tipo url
    - tipo datalocation que tenga impermanence por defecto)
