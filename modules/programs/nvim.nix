      ...
      settings.vim = {
        ...
        extraPlugins = {
          ...
          llama-vim = {
            ...
            setup = ''
              vim.g.llama_config = {
                endpoint_fim  = 'http://${config.ai.llama.fim.host}:${toString config.ai.llama.fim.port}/infill',
                endpoint_inst = 'http://${config.ai.llama.fim.host}:${toString config.ai.llama.fim.port}/v1/chat/completions',
                model_fim     = '${config.ai.llama.fim.model}',
                auto_fim      = true,
              }
            '';
          };
